...
function doGreenScreen() {
  ...
  if (bgImage == null || ! bgImage.complete()) {
   ...
   if (bgImage.getWidth() < fgImage.getWidth() || bgImage.getHeight() < fgImage.getHeight()) {
    alert("Background image must be the same size or smaller than the foreground image");
